...
class SMART_EditEditFluxPipeline(RFEditingFluxPipeline):
        ...
        with self.progress_bar(total=interpolate_end_step) as progress_bar:
            for step_idx, t_curr in enumerate(timesteps):
                ...
                if num_inference_steps - step_idx > interpolate_start_step:
                    ...
                    joint_attention_kwargs["attention_weight_control"] = False
...
class SMART_EditEditSD35Pipeline(RFEditingSD35Pipeline):
    @torch.inference_mode()
    def __call__(
        self,
        source_img: str | Image.Image,
                ...
                if num_inference_steps - step_idx > interpolate_start_step:
                    ...
                    for _ in range(num_average_steps):
                        ...
                        if do_classifier_free_guidance:
                            ...
                            latent_model_input_source = source_img_latents_noisy
